...
const LatestActivities = () => {
    const {data: audit, isLoading: isLoadingAuit, isError, error} = useList({
        resource: "audits",
        meta: {
    ...
    const isLoading = isLoadingAuit || isLoadingDeals
  ...
  return (
    <Card
        ...
        title={(
            <div style={{padding: "flex", alignItems: "center", gap: "8px"}}>
